...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		{
			aplhabetkey();
			document.getElementById("d1").innerHTML="Você apertou uma tecla alfabeto";
			console.log("alphabet key");
		}
		else if((keyPressed >=48 && keyPressed<=57))
		{
numberkey();
document.getElementById("d1").innerHTML="Você apertou um número"
console.log("number key");
		}
		else if((keyPressed >=37 && keyPressed<=40))
		{
arrowkey();
document.getElementById("d1").innerHTML="Você apertou uma tecla direcional"
console.log("arrow key");
		}
		else if((keyPressed == 17 || keyPressed == 18 || keyPressed == 27))
		{
specialkey();
document.getElementById("d1").innerHTML="Você apertou uma tecla especial"
